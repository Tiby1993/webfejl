...
var routes = [
    ...
    { path: 'signup/:userParam', component: _signup_signup_component__WEBPACK_IMPORTED_MODULE_4__["SignupComponent"] },
...
module.exports = "<ul>\n  <li><a routerLink=\"/login\">Login</a></li>\n  <li><a [routerLink]=\"['/signup', param]\">Signup in HTML</a></li>\n  <li><a (click)=\"navigateToSignup()\">Signup in TS</a></li>\n  <li><a routerLink=\"/home\">Home</a></li>\n</ul>\n<app-header></app-header>\n<app-menu></app-menu>\n<app-content></app-content>\n<app-login></app-login>\n\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, ItemService) {
        this.router = router;
        this.ItemService = ItemService;
        this.title = 'angular-basics5';
        this.param = 'jankiz';
    }
    AppComponent.prototype.ngOnInit = function () {
        return console.log(this.ItemService.getItems());
    };
    AppComponent.prototype.navigateToSignup = function () {
...
/* harmony import */ var _item_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./item.service */ "./src/app/item.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]
            ],
            providers: [_item_service__WEBPACK_IMPORTED_MODULE_13__["ItemService"]],
...
var ItemService = /** @class */ (function () {
    function ItemService(_http) {
        this._http = _http;
        this.apiUrl = "https://api.dropboxapi.com/2/files/list_folder";
    }
    ItemService.prototype.getItems = function () {
        this._http.post(this.apiUrl, path, httpOptions);
    };
    ;
...
module.exports = "<div class=\"col-sm-3 col-md-2 sidebar\">\n  <ul class=\"nav nav-sidebar\">\n    <li class=\"active\"><a href=\"1\">Overview <span class=\"sr-only\">(current)</span></a></li>\n    <li><a routerLink=\"/login\">Login</a></li>\n    <li><a href=\"3\">Analytics</a></li>\n    <li><a href=\"4\">Export</a></li>\n  </ul>\n  <ul class=\"nav nav-sidebar\">\n    <li><a href=\"\">Nav item</a></li>\n    <li><a href=\"\">Nav item again</a></li>\n    <li><a href=\"\">One more nav</a></li>\n    <li><a href=\"\">Another nav item</a></li>\n    <li><a href=\"\">More navigation</a></li>\n  </ul>\n  <ul class=\"nav nav-sidebar\">\n    <li><a href=\"\">Nav item again</a></li>\n    <li><a href=\"\">One more nav</a></li>\n    <li><a href=\"\">Another nav item</a></li>\n  </ul>\n</div>"
...
module.exports = __webpack_require__(/*! C:\Users\Tibor\Desktop\angular-basics5\src\main.ts */"./src/main.ts");
