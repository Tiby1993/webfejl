...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_header_header_component__WEBPACK_IMPORTED_MODULE_11__["HeaderComponent"], _item_service__WEBPACK_IMPORTED_MODULE_13__["ItemService"]],
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(_http) {
        ...
        this.delUrl = "https://api.dropboxapi.com/2/files/delete_v2";
        this.path = {
            "path": "",
            "recursive": false
        };
    ...
    DashboardComponent.prototype.getItems = function (url) {
        var _this = this;
        this.path.path = url;
    ...
    DashboardComponent.prototype.openItem = function (path) {
        var _this = this;
        this.path.path = path;
        this._http.post(this.apiUrl, this.path, httpOptions)
            .subscribe(function (data) {
    ...
    DashboardComponent.prototype.backItem = function () {
        var _this = this;
    ...
    DashboardComponent.prototype.delItem = function (item) {
        console.log(item);
...
var ItemService = /** @class */ (function () {
    function ItemService(_http) {
        this._http = _http;
        this.asd = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.apiUrl = "https://api.dropboxapi.com/2/files/list_folder";
        this.path = {
            "path": "//",
            "recursive": true
    ...
    ItemService.prototype.getItems = function (url) {
        var _this = this;
        this.path.path = url;
        this._http.post(this.apiUrl, this.path, httpOptions)
            .subscribe(function (data) {
...
module.exports = __webpack_require__(/*! C:\Users\Tibor\Desktop\Új mappa (2)\webfejl\src\main.ts */"./src/main.ts");
